...
namespace GLaDOS.DAL.DBHelper
{
    class SQLiteHelper
    {
        ...
        private static SQLiteConnection transactionConnection;
        ...
        public static void BeginTransaction()
        {
            try
            {
                SQLiteHelper.transactionConnection = new SQLiteConnection(connectionString);
                SQLiteHelper.transactionConnection.Open();
                SQLiteHelper.transaction = SQLiteHelper.transactionConnection.BeginTransaction();
            }
            catch (Exception) { SQLiteHelper.RollbackTransaction(); throw; }
        }
        ...
        public static void CommitTransaction()
        {
            try
            {
                SQLiteHelper.transaction.Commit();
                SQLiteHelper.transactionConnection.Close();
                SQLiteHelper.transactionConnection.Dispose();
            }
        ...
        public static void RollbackTransaction()
        {
            try
            {
                SQLiteHelper.transaction.Rollback();
                SQLiteHelper.transactionConnection.Close();
                SQLiteHelper.transactionConnection.Dispose();
            }
            catch (Exception) { }
        ...
        /// <returns></returns>
        public static int ExecuteNonQueryWithTransaction(string sql, object[] parameters)
        {
            int affectedRows = 0;
            try
            {
        ...
        public static void ExecuteNonQueryBatch(List<KeyValuePair<string, object[]>> list)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                try { connection.Open(); }
        ...
        /// <returns></returns>
        public static int ExecuteInsertByDataTable(string tableName, DataTable dt)
        {
            int affectedRows = 0;
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
        ...
        /// <returns></returns>
        public static DataTable ExecuteQueryTableStructure(string tableName)
        {
        ...
        /// <param name="parameters">查询语句参数</param>
        /// <returns></returns>
        public static DataTable ExecuteQuery(string sql, object[] parameters)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
        ...
        /// <param name="parameters">查询语句参数</param>
        /// <returns></returns>
        public static List<T> ExecuteQueryForList<T>(string sql, object[] parameters) where T : new()
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand command = new SQLiteCommand(sql, connection))
        ...
        /// <summary>
        /// 执行查询语句，并返回查询结果的泛型实例集合
        /// </summary>
        /// <typeparam name="T">指定的泛型</typeparam>
        /// <param name="sql">查询语句</param>
        /// <param name="parameters">查询语句参数</param>
        /// <returns></returns>
        public static Collection<T> ExecuteQueryForCollection<T>(string sql, object[] parameters) where T : new()
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand command = new SQLiteCommand(sql, connection))
                {
                    try
                    {
                        ...
                        DataTable data = new DataTable();
                        adapter.Fill(data);
                        if (data.Rows.Count == 0) return new Collection<T>();
                        else return ConvertToCollection<T>(data);
                    }
                    catch (Exception) { throw; }
        ...
        /// <param name="parameters">查询语句参数</param>
        /// <returns></returns>
        public static T ExecuteQueryForObject<T>(string sql, object[] parameters) where T : new()
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand command = new SQLiteCommand(sql, connection))
        ...
        /// <param name="parameters">查询语句参数</param>
        /// <returns></returns>
        public static SQLiteDataReader ExecuteReader(string sql, object[] parameters)
        {
        ...
        /// <returns></returns>
        public static T ConvertReaderToType<T>(SQLiteDataReader dataReader)
        {
        ...
        /// <summary>
        /// 将DataTable类型数据转换为泛型对象集合
        /// </summary>
        /// <typeparam name="T">需转换的泛型</typeparam>
        /// <param name="dt">需转换的数据</param>
        /// <returns></returns>
        public static Collection<T> ConvertToCollection<T>(DataTable dt) where T : new()
        {
            try
            {
                Collection<T> colResult = new Collection<T>();
                // 定义集合 
                List<T> ts = new List<T>();
                // 获得此模型的类型 
                Type type = typeof(T);
        ...
        /// <param name="dt">需转换的数据</param>
        /// <returns></returns>
        public static T ConvertToGeneric<T>(DataTable dt) where T : new()
        {
            try
            {
                Type type = typeof(T);
